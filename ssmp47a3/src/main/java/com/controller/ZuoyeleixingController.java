...
public class ZuoyeleixingController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZuoyeleixingEntity zuoyeleixing, HttpServletRequest request){
        EntityWrapper<ZuoyeleixingEntity> ew = new EntityWrapper<ZuoyeleixingEntity>();
		PageUtils page = zuoyeleixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zuoyeleixing), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZuoyeleixingEntity> wrapper = new EntityWrapper<ZuoyeleixingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zuoyeleixingService.selectCount(wrapper);
