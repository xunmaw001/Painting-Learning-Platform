...
public class JiangshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiangshiEntity user = jiangshiService.selectOne(new EntityWrapper<JiangshiEntity>().eq("gonghao", username));
    ...
    public R register(@RequestBody JiangshiEntity jiangshi){
    	...
    	JiangshiEntity user = jiangshiService.selectOne(new EntityWrapper<JiangshiEntity>().eq("gonghao", jiangshi.getGonghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiangshiEntity jiangshi, HttpServletRequest request){
        EntityWrapper<JiangshiEntity> ew = new EntityWrapper<JiangshiEntity>();
		PageUtils page = jiangshiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiangshi), params), params));
        return R.ok().put("data", page);
    }
