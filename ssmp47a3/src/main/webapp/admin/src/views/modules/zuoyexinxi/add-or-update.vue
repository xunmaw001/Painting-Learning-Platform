          ...
          <el-form-item class="input" label="作业编号" prop="zuoyebianhao">
              <el-input v-model="ruleForm.zuoyebianhao" 
                placeholder="作业编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业题目" prop="zuoyetimu">
          <el-input v-model="ruleForm.zuoyetimu" 
              placeholder="作业题目" clearable  :readonly="ro.zuoyetimu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作业题目" prop="zuoyetimu">
              <el-input v-model="ruleForm.zuoyetimu" 
                placeholder="作业题目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="作业类型" prop="zuoyeleixing">
          <el-select v-model="ruleForm.zuoyeleixing" placeholder="请选择作业类型">
            <el-option
                v-for="(item,index) in zuoyeleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
